...
> 静态网站部署于CDN边缘节点虽能抵御常规DDoS，但面临针对性资源消耗攻击时仍会失效。2025年12月，本站遭受峰值1.95GB/s、总计6.65TB的大规模攻击，导致国内CDN触发限频保护。攻击者随后利用大量国内肉鸡IP绕过地理屏蔽与速率限制，通过海量TCP连接消耗带宽，迫使CDN平台因资源滥用而封禁域名。实验证明，国内CDN在处理高并发、多源IP攻击时防护上限较低，且无法通过简单的L7层规则彻底拦截。最终，本站及相关API全量迁移至Cloudflare，通过其高强度防护机制解决服务中断问题。针对静态站点的攻击核心在于利用CDN的资源管控机制达成断网目的，而非直接击穿CDN设施。
